%%%
    ...
    name = "Internet-Draft"
    value = "draft-ietf-perc-dtls-tunnel-10"
    stream = "IETF"
...
[RFC EDITOR: References to RFC 6347 can be changed to the RFC for DTLS 1.3
if available.]
...
SDP [@!RFC4566] attribute in all offer and answer messages [@!RFC3264]
...
values received from the SDP transmitted by the endpoint [@!RFC8122].
