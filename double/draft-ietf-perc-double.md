%%%
    ...
    abbrev = "Double SRTP"
    category = "std"
    docName = "draft-ietf-perc-double-06"
    ipr= "trust200902"
    area = "Internet"
...
used instead.  One way to do this is to send DTMF with [@RFC6086],
which will be sent in the signalling thus allowing the relay to
read the DTMF.
